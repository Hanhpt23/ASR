...
def parse_args():
    ...
    parser.add_argument('--freeze_specific_layers_decoder', type=list, default=None, help='Specific layers to freeze in the decoder.')
...
def train_whisper_model(args):
    ...
    if args.freeze_specific_layers_decoder:
        logger.info("Freezing specific layers in decoder!")
        for name, param in model.named_parameters():
