...
#SBATCH --job-name=vE0-8D0:8       # create a short name for your job
#SBATCH --output=./gpu_output/Train_whisper-small-vietmed-freeE[0-8]-D[0:8]-JOB_ID_%j-%N.log # create output file
...
python3 -m src.train_free-layers \
    --output_dir "./whisper-small-vietmed-free_E0-8D0-8" \
    ...
    --freeze_specific_layers_encoder '0, 1, 2, 3, 4, 5, 6, 7, 8' \
