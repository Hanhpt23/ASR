...
#SBATCH --job-name=vE0:8       # create a short name for your job
#SBATCH --output=./gpu_output/Train_whisper-small-vietmed-freeEncoder[0:8]-JOB_ID_%j-%N.log # create output file
...
python3 -m src.train_free-layers \
    --output_dir "./whisper-small-vietmed-free_E0-8" \
