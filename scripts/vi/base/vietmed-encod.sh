...
#SBATCH --job-name=B       # create a short name for your job
#SBATCH --output=./gpu_output/Test_base_encode-vietmed-JOB_ID_%j-%N.log # create output file
...
python3 -m src.train \
    --output_dir "./whisper-base-Encod-vietmed" \
