...
#SBATCH --job-name=T       # create a short name for your job
#SBATCH --output=./gpu_output/Test_tiny_encode-vietmed-JOB_ID_%j-%N.log # create output file
...
python3 -m src.train \
    --output_dir "./whisper-tiny-Encod-vietmed" \
