...
#SBATCH --job-name=M       # create a short name for your job
#SBATCH --output=./gpu_output/Test_medium_encode-vietmed-JOB_ID_%j-%N.log # create output file
...
python3 -m src.train \
    --output_dir "./whisper-medium-Encod-vietmed" \
