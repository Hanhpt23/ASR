...
#SBATCH --job-name=DS13D       # create a short name for your job
#SBATCH --output=./gpu_output/Test_medium_vietmedv1-JOB_ID_%j-%N.log # create output file
...
# --report_to "wandb" \ changed to none

python3 -m src.train \
    --output_dir "./whisper-medium-vietmed-v1" \
